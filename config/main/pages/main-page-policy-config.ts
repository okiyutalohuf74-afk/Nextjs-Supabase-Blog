...
const mainPagePolicyConfig: PolicyPageType = {
  ...
  description:
    "This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from royalreelsdirect.com (the “Site”).",
  paragraphs: [
    {
